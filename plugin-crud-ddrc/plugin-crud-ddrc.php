...
// DDRC-comentario: funcion que se activa cuando el plugion se desacriva
function Desactivar()
{
    //Reinicia todos los ajustes dentro de wordpress y los reescribe
    flush_rewrite_rules();
}
// DDRC-comentario: Registra la funcion de activacion del boton de antivar de worpress
